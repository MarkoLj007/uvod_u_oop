class Ucenik:
    ...
    def ucitaj_ucenike(ime_datoteke):
        ...
        with open(ime_datoteke, mode="r", encoding="utf-8") as datoteka:
            ...
            for red in reader:
                p = Ucenik(red["ime"], red["prezime"], red["razred"], float(red["ocjene"]))
    ...
    while True: 
        ...
        try:
            ...
            if izbor == 1:
                ...
                ime = input("Unesite ime učenice: ")
                prezime = input("Unesite prezime učenice: ")
                razred = input("Unesite razred učenice: ")
